...
const AboutPage = () => (
  <Layout>
    ...
    <div className="container">
      ...
      <p>It is based on v2.0 of the <a href="https://images-cdn.fantasyflightgames.com/filer_public/51/55/51552c7f-c05c-445b-84bf-4b073456d008/ti10_pok_living_rules_reference_20_web.pdf" target="_blank">Living Rules Reference</a>.</p>

      <h4>I have a question that isn't answered here. What can I do?</h4>
      <p>You might also want to read TI4 designer Dane Beltrami's <a href="https://docs.google.com/document/d/1_93kw7KkzvAXoQAxRioxo7iAt-Ar6BMIxdNf4Lv25rI/edit" target="_blank">answers to FAQs about Prophecy of Kings</a>. These answers haven't been incorporated into an LRR update yet but are considered official.</p>
